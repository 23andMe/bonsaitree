...
def test_remove_symmetric_ancestors():
    ...
    po = PedigreeObject(up_dict)
    potential_open_ancestor_set = {-2, -4, -6, -8, -10, -11, -12}
    open_ancestor_set = remove_symmetric_ancestors(
        open_set = potential_open_ancestor_set,
        po = po,
    )
    # check that we have removed either -11 or -12
    assert(open_ancestor_set == {-2, -4, -6, -8, -10, -11} or open_ancestor_set == {-2, -4, -6, -8, -10, -12})
